const countdown = () =>{
    ...
    textday < 10? dday.textContent = '0' + textday: dday.textContent = textday;
    texthour < 10? dhour.textContent = '0' + texthour: dhour.textContent = texthour;
    textminutes < 10? dminutes.textContent = '0' + textminutes: dminutes.textContent = textminutes;
    textseconds < 10? dseonds.textContent = '0' + textseconds: dseonds.textContent = textseconds;
